          ...
          >
            <div className="flex-1 w-full grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex flex-col space-y-2">
                <label className="text-xs font-bold uppercase text-gray-500 tracking-wider ml-1">Check-in</label>
              ...
              <div className="flex flex-col space-y-2">
                <label className="text-xs font-bold uppercase text-gray-500 tracking-wider ml-1">Check-out</label>
                <div className="relative bg-gray-50 rounded-lg overflow-hidden hover:bg-gray-100 transition-colors cursor-pointer group">
                   <input
                     type="date"
              ...
              <div className="flex flex-col space-y-2">
                <label className="text-xs font-bold uppercase text-gray-500 tracking-wider ml-1">Guests</label>
                <div className="relative bg-gray-50 rounded-lg overflow-hidden hover:bg-gray-100 transition-colors cursor-pointer group">
                   <select
      ...
      <section id="rooms" className="py-24 bg-gray-50">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-sm font-bold text-[#006b54] tracking-widest uppercase mb-2">Accommodations</h2>
            <h3 className="text-3xl md:text-4xl font-bold text-gray-900">Our Signature Rooms</h3>
            <p className="mt-4 text-gray-500 max-w-2xl mx-auto">
              Choose from our carefully designed rooms, each offering a unique blend of comfort and style.
            </p>
          </div>
            ...
            {ROOMS.map((room) => (
              <div 
                ...
                className={`bg-white rounded-2xl overflow-hidden shadow-lg group hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex flex-col ${
                  room.id === 'suite' ? 'ring-2 ring-[#006b54] ring-offset-2 shadow-xl' : ''
                }`}
              >
                <div className="h-64 overflow-hidden relative">
                  ...
                  />
                  <div className={`absolute top-4 right-4 ${room.id === 'suite' ? 'bg-[#006b54] text-white' : 'bg-white/90 backdrop-blur-sm text-[#006b54]'} px-3 py-1 rounded-lg text-xs font-bold`}>
                     {room.sizeSqM} sq.m.
                  </div>
                </div>
                <div className="p-8 flex-1 flex flex-col relative">
                  {room.id === 'suite' && (
                    <div className="absolute top-0 right-0 bg-[#006b54] text-white text-[10px] font-bold px-3 py-1 rounded-bl-lg uppercase">Best Value</div>
                  )}
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 mb-6">
                    <div className="flex justify-between items-center mb-2 pb-2 border-b border-gray-200 border-dashed">
                      ...
                      <span className="text-lg font-bold text-gray-900">{room.rates.daily.general.toLocaleString()} <span className="text-xs font-normal text-gray-500">THB</span></span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-bold text-[#006b54]">{room.rates.daily.personnel.toLocaleString()} <span className="text-xs font-normal text-[#006b54]/70">THB</span></span>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4">
           <div className="max-w-7xl mx-auto">
             <div className="grid md:grid-cols-2 gap-16 items-center">
               <div>
                 <h2 className="text-sm font-bold text-[#006b54] tracking-widest uppercase mb-2">Location & Convenience</h2>
                 <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Why Choose KU Home?</h3>
                 <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                   Situated perfectly within the Kasetsart University campus, we offer unparalleled convenience for visiting faculty, students, and guests.
                 </p>
                 ...
                 <div className="space-y-6">
                   <div className="flex items-start">
                     ...
                     <div>
                       <h4 className="text-xl font-bold text-gray-900 mb-1">BTS Connectivity</h4>
                       <p className="text-gray-500">Minutes away from BTS Kasetsart University Station (Green Line), connecting you to the heart of Bangkok.</p>
                     </div>
                   </div>
                   <div className="flex items-start">
                     <div className="bg-[#006b54]/10 p-3 rounded-xl mr-4 text-[#006b54]">
                     ...
                     <div>
                       <h4 className="text-xl font-bold text-gray-900 mb-1">On-Campus Location</h4>
                       <p className="text-gray-500">Located at Gate 2, Ngamwongwan Road. Direct access to all university facilities and faculties.</p>
                     </div>
                   </div>
                   <div className="flex items-start">
                     <div className="bg-[#006b54]/10 p-3 rounded-xl mr-4 text-[#006b54]">
                     ...
                     <div>
                       <h4 className="text-xl font-bold text-gray-900 mb-1">Secure & Private</h4>
                       <p className="text-gray-500">24/7 security, keycard access, and a peaceful environment conducive to rest and study.</p>
                     </div>
                   </div>
                 </div>
               </div>
               ...
               <div className="relative">
                 ...
                 <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-xl z-20 flex items-center space-x-4 max-w-xs">
                    ...
                    <div>
                      <div className="text-sm font-bold text-gray-900">Prime Location</div>
                      <div className="text-xs text-gray-500">50 Ngamwongwan Road</div>
                    </div>
                 </div>
               </div>
             </div>
